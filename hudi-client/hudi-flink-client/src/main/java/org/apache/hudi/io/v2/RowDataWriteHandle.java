...
/**
 * Base class for all handles that supports {@code RowData} writing directly at the file group level.
 */
public abstract class RowDataWriteHandle<T, I, K, O> implements MiniBatchHandle, AutoCloseable {
